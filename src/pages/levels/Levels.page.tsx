...
const LevelsPage: React.FC<any> = ({ loading, loadingStart, loadingStop }: IProps): JSX.Element => {
...
export const Levels = connect(mapStateToProps, mapDispatchToProps)(LevelsPage)
