...
const LocationPage: React.FC<any> = ({ loading, loadingStart, loadingStop }: IProps): JSX.Element => {
...
export const Location = connect(mapStateToProps, mapDispatchToProps)(LocationPage)
