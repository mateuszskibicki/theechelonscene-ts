...
const FounderPage: React.FC<any> = ({ loading, loadingStart, loadingStop }: IProps): JSX.Element => {
...
export const Founder = connect(mapStateToProps, mapDispatchToProps)(FounderPage)
